...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{ej1-chatgpt.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{ej2-chatgpt.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.2]{ej2.1-dalle.jpg}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.2]{ej3.1-dalle.jpg}
    \includegraphics[scale=0.2]{ej3.2-dalle.jpg}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.2]{ej4.1-dalle_1.jpg}
    \includegraphics[scale=0.2]{ej4.2-dalle_1.jpg}
